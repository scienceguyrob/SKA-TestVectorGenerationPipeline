...
Please note that it takes around 1 hour to build this image on the dockerhub. Also note that the image size is approximately 2.5 GB on disk. It is probably best to build locally on your own machine.
...
&lt Pulsar name&gt_&lt Freq.&gt.acn

or

&lt Pulsar name&gt_&lt Freq.&gt_&lt Number &gt.acn
