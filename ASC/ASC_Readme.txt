...
This directory contains an archive 'ASC.zip'. This in turn contains files
which describe pulse profiles extracted from the EPN database. Each file
in the zipped file is named as follows:

<Pulsar name>_<Frequency>.asc

Where <Pulsar name> is the pulsar 'J' name, and <Frequency> the observation
frequency of the EPN data.
